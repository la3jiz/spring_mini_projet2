...
http.authorizeRequests().antMatchers("/saveTask").hasAnyRole("ADMIN","AGENT");
http.authorizeRequests().antMatchers("/ListeTasks")
.hasAnyRole("ADMIN","AGENT","USER");
http.authorizeRequests()
.antMatchers("/supprimerTask","/modifierTask","/updateTask")
.hasAnyRole("ADMIN");
